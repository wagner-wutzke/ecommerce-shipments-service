...
class KafkaConfigTest {
  ...
  void setUp() {
    ...
    ReflectionTestUtils.setField(config, "consumerGroup", "test");
    ReflectionTestUtils.setField(config, "trustedPackages", "net.wowdev.ecommerce");
  ...
  void createsFactories() {
    ...
    assertNotNull(config.kafkaListenerContainerFactory(config.consumerFactory(), template));
  }
}
